...
/***************************************************************************
 ...
 Edited by James Mercer to include more information
                              -------------------
        begin                : 2020-07-04
        git sha              : $Format:%H$
...
class CoordinateCapture:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Coordinate Capture Extra')
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'Coordinate Capture Extra'),
            callback=self.run,
    ...
    def run(self):
        ...
        if not self.pluginIsActive:
            ...
            if self.dockwidget == None:
                ...
                self.dockwidget.moreInfo.clicked.connect(self.moreInfoClicked)
